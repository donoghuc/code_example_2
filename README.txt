...
Installation:
i have provided you (the grader) with a single .zip archive with the following
...
-my general model (as with project 1) was to implement both clien and server in python3 then 
translate to C. I decided not to include the python3 version of the server for submission but is
